...
3. **`extract/claim_graphs/layers.py`** — what a layer runner is obliged to do.
...
See [the prompts](/claim-graphs/docs/prompts/). Briefly: a variant is a directory under
...
[`evaluate`](/claim-graphs/docs/evaluate/) before keeping it.
