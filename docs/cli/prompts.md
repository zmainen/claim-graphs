...
| File | Layer | Reads |
|:-----|:------|:------|
| `results-reader.md` | [`results-reader`](/claim-graphs/pipeline/results-reader/) | The abstract and results prose |
| `caption-reader.md` | [`caption-reader`](/claim-graphs/pipeline/caption-reader/) | The figure and table captions |
| `structure-reader.md` | [`structure-reader`](/claim-graphs/pipeline/structure-reader/) | The methods, supplements and section structure |
| `reconciler.md` | [`reconcile`](/claim-graphs/pipeline/reconcile/) | The three readers' outputs |
| `external-reviewer.md` | [`external-review`](/claim-graphs/pipeline/external-review/) | The paper plus the reconciled draft |
| `edge-inference.md` | [`edge-inference`](/claim-graphs/pipeline/edge-inference/) | The draft's claims, numbered |
| `coverage-adjudicator.md` | [`adjudication`](/claim-graphs/pipeline/adjudication/) | Unresolved coverage spans against the claim tree |
...
[`results-reader`](/claim-graphs/pipeline/results-reader/) is the prompt that produced the
claims below it on the same page. The [agents page](/claim-graphs/pipeline/induction/)
...
```bash
claim-graphs evaluate --reference-dir ../claims/ --work-dir /tmp/eval \
  --all --prompt-variant my-variant
```

Diff the aggregate against the baseline. See
[measuring a prompt change](/claim-graphs/docs/evaluate/) for the discipline, and for the
