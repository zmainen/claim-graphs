...
[Install and configure](/claim-graphs/docs/install/) the package, and check that
...
[pipeline page](/claim-graphs/pipeline/) draws as a graph, because both read
...
```bash
cd extract
python3 -m claim_graphs.cli prepare --paper <your-slug> --doi 10.7554/eLife.<id>
cd ..
```
