...
**Issue:** [#75](https://github.com/zmainen/claim-graphs/issues/75)
**Frames:** [#56](https://github.com/zmainen/claim-graphs/issues/56) · [#19](https://github.com/zmainen/claim-graphs/issues/19)
...
the `cg:` namespace of the extended file and the gap report says so, like `entails` does
