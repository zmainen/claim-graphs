...
behind two corpus-scope layers — [claim-format](/claim-graphs/pipeline/claim-format/),
which asks what a claim is, and
[relation-vocab](/claim-graphs/pipeline/relation-vocab/), which asks what each relation
...
[stance layer](/claim-graphs/pipeline/stance/) found five eliminative relations aiming at
...
[reference-check layer](/claim-graphs/pipeline/reference-check/) resolves them against
...
has. The [replication layer](/claim-graphs/pipeline/replication/) is declared with no
...
[an open question](/claim-graphs/pipeline/relation-vocab/) rather than a settled
distinction.
...
[relation-vocab](/claim-graphs/pipeline/relation-vocab/).
