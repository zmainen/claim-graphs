...
<!-- Generated by `claim-graphs skill --write` from docs/skill/references/presentation.md and the declarations named in extract/claim_graphs/skill.py. Do not edit: edit the source or the declaration and regenerate. `make check` fails when this file is not what they generate. -->
