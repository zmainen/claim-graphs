...
The review operates on OXA claim nodes, uses persona files, and produces
...
# Persona directory. No default: a persona library is the deployment's, not this package's, and
# the previous default pointed into one particular machine's private project tree.
PERSONA_DIR = Path(os.environ["CLAIM_GRAPHS_PERSONA_DIR"]) \
    if os.environ.get("CLAIM_GRAPHS_PERSONA_DIR") else None
...
def _load_persona(slug: str) -> dict:
    """Load a persona from the configured persona library."""
