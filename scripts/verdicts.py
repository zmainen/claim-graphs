...
from claim_graphs import verdicts as vd  # noqa: E402
...
def _draft_from_tree(paper: str, cdir: Path, res: "vd.Resolved"):
    ...
    """
    from claim_graphs.schema import DraftClaimTable, ReconciledClaim
...
def cmd_apply(args) -> int:
    ...
    from claim_graphs.write import archive_dir, carry_over, write_claim_files
    cfg = Config()
    cfg.root = ROOT
