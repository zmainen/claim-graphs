...
def neighbours(paper: str) -> dict[str, tuple[str, str]]:
    ...
    """
    from claim_graphs.layers import read_prepared          # noqa: PLC0415
    from claim_graphs.segment import segment               # noqa: PLC0415
    from claim_graphs.config import Config                 # noqa: PLC0415
    try:
