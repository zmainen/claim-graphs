...
from claim_graphs import edges as E  # noqa: E402
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "extract"))
from claim_graphs.claimfile import frontmatter, loadable  # noqa: E402
...
def build_prompt(paper: str) -> tuple[str, str]:
    ...
    from claim_graphs.prompts import prompt as compose
...
def apply(paper: str, edges: list[dict]) -> list[Path]:
    ...
    from claim_graphs.write import _format_claim_file
